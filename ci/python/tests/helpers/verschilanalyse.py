...
def make_verschillentool_workbook_3d(
    ...
    for row in [
        ...
        ["sea_water_salinity (ppt)", "2-1-2035  11:00:00", salinity_stats.max, "3D variable"],
    ...
    for row in [
        ...
        ["sea_water_salinity_bias (ppt)", salinity_stats.avg_bias],
        ["sea_water_salinity_max (ppt)", salinity_stats.avg_max],
        ["sea_water_salinity_rms (ppt)", salinity_stats.avg_rms],
    ]:
