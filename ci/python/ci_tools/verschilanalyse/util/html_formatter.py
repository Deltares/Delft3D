...
class HtmlFormatter:
    ...
    def _to_rows(
        ...
        water_lvl_exceeded = (
            set(cls._exceeded_water_level_models(his_outputs))
            | set(cls._exceeded_water_level_models(map_outputs))
        )
        flow_vel_exceeded = (
            set(cls._exceeded_flow_velocity_models(his_outputs))
            | set(cls._exceeded_flow_velocity_models(map_outputs))
        )
