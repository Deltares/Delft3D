...
object LinuxSubmitH7ContainerSmokeTest :
        BuildType({
            templates(TemplateMonitorPerformance, TemplateDockerRegistry)
            ...
            params {
                ...
                param(
                        ...
                        "containers.deltares.nl/delft3d-dev/delft3d-runtime-container:alma8-%dep.${LinuxBuild.id}.product%-%dep.${LinuxBuild.id}.commit_id%"
                )
                param(
                        "testbench_container_image",
                        "containers.deltares.nl/delft3d-dev/test/delft3d-test-container:alma8-%dep.${LinuxBuild.id}.product%-%dep.${LinuxBuild.id}.commit_id%"
                )
                ...
                password(
                        "h7_account_password",
                        DslContext.getParameter("ad_h7_smoke_test_password")
                )
