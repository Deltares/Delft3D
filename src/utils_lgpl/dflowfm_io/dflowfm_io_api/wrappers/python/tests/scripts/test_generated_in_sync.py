...
class TestGeneratedFilesInSync(unittest.TestCase):
    """The on-disk generated schema must equal a fresh regeneration — catches a hand-edited or stale
    generated file (schema.py is produced by the build, not committed)."""
