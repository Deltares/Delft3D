...
#: Every property key ("section.property", lower-cased) the MDU schema defines.
KNOWN_PROPERTIES = frozenset({
    "calibration.areafile",
    "calibration.definitionfile",
    "calibration.usecalibration",
    "external forcing.evaporation",
    "external forcing.extforcefile",
    "external forcing.extforcefilenew",
    "external forcing.qext",
    "external forcing.rainfall",
    "external forcing.windext",
    "general.autostart",
    "general.convertlongculverts",
    "general.filetype",
    "general.fileversion",
    "general.guiversion",
    "general.inputspecific",
    "general.modelspecific",
    "general.pathsrelativetoparent",
    "general.program",
    "general.version",
    "geometry.1d2dinternallinktype",
    "geometry.1d2dlinkfile",
    "geometry.1dnetworkfile",
    "geometry.allowbndatbifurcation",
    "geometry.anglat",
    "geometry.anglon",
    "geometry.bamin",
    "geometry.bathymetryfile",
    "geometry.bedlevelfile",
    "geometry.bedlevmode",
    "geometry.bedlevtype",
    "geometry.bedlevuni",
    "geometry.bedslope",
    "geometry.bedwaveamplitude",
    "geometry.bedwavelength",
    "geometry.blmeanbelow",
    "geometry.blminabove",
    "geometry.botlevtype",
    "geometry.botlevuni",
    "geometry.calculatebedlevelovernonactivelinks",
    "geometry.changestructuredimensions",
    "geometry.changevelocityatstructures",
    "geometry.circumcenter",
    "geometry.circumcentermethod",
    "geometry.circumcentertolerance",
    "geometry.conveyance2d",
    "geometry.cosphiutrsh",
    "geometry.createlinks1d2d",
    "geometry.crossdeffile",
    "geometry.crosslocfile",
    "geometry.cutcelllist",
    "geometry.dcenterinside",
    "geometry.dpuopt",
    "geometry.drypointsfile",
    "geometry.dxdoubleat1dendnodes",
    "geometry.dxmin1d",
    "geometry.dxwuimin2d",
    "geometry.dztop",
    "geometry.dztopuniabovez",
    "geometry.extrbl",
    "geometry.fixedweirfile",
    "geometry.floorlevtoplay",
    "geometry.frictfile",
    "geometry.grdang",
    "geometry.gridenclosurefile",
    "geometry.groundlayerthickness",
    "geometry.gulliesfile",
    "geometry.helmert",
    "geometry.ihuz",
    "geometry.ihuzcsig",
    "geometry.inifieldfile",
    "geometry.ithindykescheme",
    "geometry.keepzlay1bedvol",
    "geometry.keepzlayeringatbed",
    "geometry.kmx",
    "geometry.landboundaryfile",
    "geometry.layertype",
    "geometry.makeorthocenters",
    "geometry.manholefile",
    "geometry.netfile",
    "geometry.nodefile",
    "geometry.nonlin1d",
    "geometry.nonlin2d",
    "geometry.nooptimizedpolygon",
    "geometry.numtopsig",
    "geometry.numtopsiguniform",
    "geometry.openboundarytolerance",
    "geometry.orgfloorlevtoplaydef",
    "geometry.partitionfile",
    "geometry.pillarfile",
    "geometry.pipefile",
    "geometry.profdeffile",
    "geometry.profdefxyzfile",
    "geometry.proflocfile",
    "geometry.removesmalllinkstrsh",
    "geometry.renumberflownodes",
    "geometry.roofsfile",
    "geometry.roughnessfiles",
    "geometry.shipdeffile",
    "geometry.sigmagrowthfactor",
    "geometry.sillheightmin",
    "geometry.slotw1d",
    "geometry.slotw2d",
    "geometry.storagenodefile",
    "geometry.stretchcoef",
    "geometry.stretchtype",
    "geometry.stripmesh",
    "geometry.structurefile",
    "geometry.thindamfile",
    "geometry.thindykefile",
    "geometry.toplayminthick",
    "geometry.tsigma",
    "geometry.uniformheight1d",
    "geometry.uniformheight1droofgutterpipes",
    "geometry.uniformheight1dstreetinlets",
    "geometry.uniformhu",
    "geometry.uniformtyp1d",
    "geometry.uniformtyp1droofgutterpipes",
    "geometry.uniformtyp1dstreetinlets",
    "geometry.uniformwidth1d",
    "geometry.uniformwidth1droofgutterpipes",
    "geometry.uniformwidth1dstreetinlets",
    "geometry.usecaching",
    "geometry.vertplizfile",
    "geometry.waterdepthini1d",
    "geometry.waterlevini",
    "geometry.waterlevinifile",
    "geometry.zlaybot",
    "geometry.zlayeratubybob",
    "geometry.zlayergrowthfactor",
    "geometry.zlaytop",
    "grw.bgrwuni",
    "grw.conductivity",
    "grw.groundwater",
    "grw.h_aquiferuni",
    "grw.h_unsatini",
    "grw.hinterceptionlayer",
    "grw.infiltrationmodel",
    "grw.sgrwini",
    "grw.unifinfiltrationcapacity",
    "hydrology.interceptionmodel",
    "ice.wrihis_ice_area_fraction",
    "ice.wrihis_ice_default",
    "ice.wrihis_ice_lower_surface_height",
    "ice.wrihis_ice_open_water_level",
    "ice.wrihis_ice_pressure",
    "ice.wrihis_ice_surface_height",
    "ice.wrihis_ice_temperature",
    "ice.wrihis_ice_thickness",
    "ice.wrihis_snow_temperature",
    "ice.wrihis_snow_thickness",
    "numerics.adveccorrection1d2d",
    "numerics.advectype",
    "numerics.anticreep",
    "numerics.baorgfracmin",
    "numerics.barocponbnd",
    "numerics.barocterm",
    "numerics.baroctimeint",
    "numerics.baroczlaybed",
    "numerics.barrieradvection",
    "numerics.c1e",
    "numerics.c3estable",
    "numerics.c3eunstable",
    "numerics.cfconhormom",
    "numerics.cfexphormom",
    "numerics.cfexphu",
    "numerics.cffachormom",
    "numerics.cffachu",
    "numerics.cffacver",
    "numerics.cflmax",
    "numerics.cflwavefrac",
    "numerics.checkerboardmonitor",
    "numerics.chkadvd",
    "numerics.chkdifd",
    "numerics.corioadamsbashfordfac",
    "numerics.corioconstant",
    "numerics.coriohhtrsh",
    "numerics.cstbnd",
    "numerics.diagnostictransport",
    "numerics.diffusiononbnd",
    "numerics.drop1d",
    "numerics.drop3d",
    "numerics.dtol",
    "numerics.eddyviscositybedfacmax",
    "numerics.epseps",
    "numerics.epshstem",
    "numerics.epshu",
    "numerics.epsmaxlev",
    ...
    "numerics.epstke",
    "numerics.faclaxturb",
    "numerics.faclaxturbhor",
    "numerics.faclaxturbver",
    "numerics.filter",
    "numerics.filterorder",
    "numerics.fixedweir1d2d_dx",
    "numerics.fixedweircontraction",
    "numerics.fixedweirfrictscheme",
    "numerics.fixedweirrelaxationcoef",
    "numerics.fixedweirscheme",
    "numerics.fixedweirscheme1d2d",
    "numerics.fixedweirtalud",
    "numerics.fixedweirtopfrictcoef",
    "numerics.fixedweirtopwidth",
    "numerics.flowsolver",
    "numerics.hkad",
    "numerics.horadvtypzlayer",
    "numerics.horizontalmomentumfilter",
    "numerics.huweirregular",
    "numerics.icgsolver",
    "numerics.icoriolistype",
    "numerics.ilutype",
    "numerics.implicitdiffusion2d",
    "numerics.ithindykescheme",
    "numerics.izbndpos",
    "numerics.jadrhodz",
    "numerics.jaembed1d",
    "numerics.jaorgsethu",
    "numerics.jarhoxu",
    "numerics.jasfer3d",
    "numerics.jaupwindsrc",
    "numerics.jbasqbnddownwindhs",
    "numerics.jposhchk",
    "numerics.junction1d",
    "numerics.keepstbndonoutflow",
    "numerics.keepzlayeringatbed",
    "numerics.lateral_fixedweir_minimal_1d2d_embankment",
    "numerics.lateral_fixedweir_relax",
    "numerics.lateral_fixedweir_umin",
    "numerics.lateral_fixedweir_umin_method",
    "numerics.limtyphu",
    "numerics.limtypmom",
    "numerics.limtypsa",
    "numerics.limtypw",
    "numerics.lincontin",
    "numerics.linkdriedmx",
    "numerics.locsaltlev",
    "numerics.locsaltmax",
    "numerics.locsaltmin",
    "numerics.logprofatubndin",
    "numerics.logprofkepsbndin",
    "numerics.logsolverconvergence",
    "numerics.maxdegree",
    "numerics.maxitpresdens",
    "numerics.maxitverticalforester",
    "numerics.maxitverticalforestersal",
    "numerics.maxitverticalforestertem",
    "numerics.maxnonlineariterations",
    "numerics.maxssc",
    "numerics.maxvelocity",
    "numerics.maxvelocitydiff",
    "numerics.maxwaterleveldiff",
    "numerics.mintimestepbreak",
    "numerics.minwaterlevelchangebreak",
    "numerics.newcorio",
    "numerics.nlevel",
    "numerics.noderivedtypes",
    "numerics.numlimdt_baorg",
    "numerics.orgbarockeywords",
    "numerics.perottype",
    "numerics.perotweightupdate",
    "numerics.pillarfarfieldvelocity",
    "numerics.pure1d",
    "numerics.qhrelax",
    "numerics.rhointerfaces",
    "numerics.sethorizontalbobsfor1d2d",
    "numerics.slopedrop2d",
    "numerics.sobekdfm_minimal_1d2d_embankment",
    "numerics.sobekdfm_umin",
    "numerics.sobekdfm_umin_method",
    "numerics.structurelayersactive",
    "numerics.subsuplupdates1",
    "numerics.testdryingflooding",
    "numerics.testfixedweirs",
    "numerics.teta0",
    "numerics.thindykecontraction",
    "numerics.timesteptype",
    "numerics.tlfsmo",
    "numerics.transportautotimestepdiff",
    "numerics.transportmethod",
    "numerics.transporttimestepping",
    "numerics.trsh_u1lb",
    "numerics.tspinupturblogprof",
    "numerics.turbulenceadvection",
    "numerics.turbulencemodel",
    "numerics.turbulencetimeintegrationfactor",
    "numerics.turbulencetimeintegrationmethod",
    "numerics.velmagnwarn",
    "numerics.velocitywarn",
    "numerics.vertadvtypmom",
    "numerics.vertadvtypmom3onbnd",
    "numerics.vertadvtypsal",
    "numerics.vertadvtyptem",
    "numerics.verticaladvectiontype",
    "numerics.waterlevelwarn",
    "numerics.wridia_viscosity_diffusivity_limit",
    "numerics.zerozbndinflowadvection",
    "numerics.zlayercenterbedvel",
    "numerics.zwsbtol",
    "output.avgwaveoutputinterval",
    "output.classmapfile",
    "output.classmapinterval",
    "output.cominterval",
    "output.comoutputtimevector",
    "output.crsfile",
    "output.deleteobspointsoutsidegrid",
    "output.enabledebugarrays",
    "output.eulervelocities",
    "output.flowgeomfile",
    "output.foufile",
    "output.fouupdatestep",
    "output.fullgridoutput",
    "output.generateuuid",
    "output.heatfluxesonoutput",
    "output.hisfile",
    "output.hisinterval",
    "output.mapfile",
    "output.mapformat",
    ...
    "output.mbainterval",
    "output.mbalumpboundaries",
    "output.mbalumpfromtomba",
    "output.mbalumpprocesses",
    "output.mbalumpsourcesinks",
    "output.mbawritecsv",
    "output.mbawritenetcdf",
    "output.mbawritetxt",
    "output.metadatafile",
    "output.nccompression",
    "output.ncformat",
    "output.nchisdataprecision",
    "output.ncmapdataprecision",
    "output.ncnoforcedflush",
    "output.ncnounlimited",
    "output.ncwritelatlon",
    "output.obsfile",
    "output.outputdir",
    "output.richardsononoutput",
    "output.rstinterval",
    "output.rugfile",
    "output.s1incinterval",
    "output.snapshotdir",
    "output.statsinterval",
    "output.timesplitinterval",
    "output.timingsinterval",
    "output.velocitydirectionclassesinterval",
    "output.velocitymagnitudeclasses",
    "output.waqfilebase",
    "output.waqhoraggr",
    "output.waqinterval",
    "output.waqoutputdir",
    "output.waqvertaggr",
    "output.waterdepthclasses",
    "output.waterlevelclasses",
    "output.wrihis_airdensity",
    "output.wrihis_balance",
    "output.wrihis_bedlevel",
    "output.wrihis_bubblescreens",
    "output.wrihis_constituents",
    "output.wrihis_crs_constituents",
    "output.wrihis_crs_flow",
    "output.wrihis_density",
    "output.wrihis_discharge",
    "output.wrihis_heat_fluxes",
    "output.wrihis_heatflux",
    "output.wrihis_infiltration",
    "output.wrihis_lateral",
    "output.wrihis_rain",
    "output.wrihis_runupgauge",
    "output.wrihis_salinity",
    "output.wrihis_sediment",
    "output.wrihis_sourcesink",
    "output.wrihis_structure_bridge",
    "output.wrihis_structure_compound",
    "output.wrihis_structure_culvert",
    "output.wrihis_structure_dam",
    "output.wrihis_structure_dambreak",
    "output.wrihis_structure_gate",
    "output.wrihis_structure_gen",
    "output.wrihis_structure_longculvert",
    "output.wrihis_structure_orifice",
    "output.wrihis_structure_pump",
    "output.wrihis_structure_uniweir",
    "output.wrihis_structure_weir",
    "output.wrihis_taucurrent",
    "output.wrihis_temperature",
    "output.wrihis_turbulence",
    "output.wrihis_upward_velocity_component",
    "output.wrihis_velocity",
    "output.wrihis_velocity_vector",
    "output.wrihis_water_quality_output",
    "output.wrihis_waterdepth",
    "output.wrihis_waterlevel_s1",
    "output.wrihis_waves",
    "output.wrihis_wind",
    "output.wrihis_wqbot",
    "output.wrihis_wqbot3d",
    "output.wrihis_zcor",
    "output.wrimap_airdensity",
    "output.wrimap_ancillary_variables",
    "output.wrimap_bnd",
    "output.wrimap_calibration",
    "output.wrimap_cdwind",
    "output.wrimap_chezy",
    "output.wrimap_chezy_on_flow_links",
    "output.wrimap_constituents",
    "output.wrimap_density_rho",
    "output.wrimap_dtcell",
    "output.wrimap_evaporation",
    "output.wrimap_every_dt",
    "output.wrimap_fixed_weir_energy_loss",
    "output.wrimap_flow_analysis",
    "output.wrimap_flow_flux_q1",
    "output.wrimap_flow_flux_q1_main",
    "output.wrimap_flowarea_au",
    "output.wrimap_freeboard",
    "output.wrimap_heat_fluxes",
    "output.wrimap_horizontal_diffusivity_diu",
    "output.wrimap_horizontal_viscosity_viu",
    "output.wrimap_ice",
    "output.wrimap_input_dt",
    "output.wrimap_input_roughness",
    "output.wrimap_interception",
    "output.wrimap_internal_tides_dissipation",
    "output.wrimap_nearfield",
    "output.wrimap_nudging",
    "output.wrimap_numlimdt",
    "output.wrimap_qin",
    "output.wrimap_rain",
    "output.wrimap_sal_potential",
    "output.wrimap_salinity",
    "output.wrimap_sediment",
    "output.wrimap_spiral_flow",
    "output.wrimap_taucurrent",
    "output.wrimap_temperature",
    "output.wrimap_tidal_potential",
    "output.wrimap_time_water_on_ground",
    "output.wrimap_total_net_inflow_1d2d",
    "output.wrimap_total_net_inflow_lateral",
    "output.wrimap_trachytopes",
    "output.wrimap_turbulence",
    "output.wrimap_upward_velocity_component",
    "output.wrimap_velocity_component_u0",
    "output.wrimap_velocity_component_u1",
    "output.wrimap_velocity_magnitude",
    "output.wrimap_velocity_vector",
    "output.wrimap_velocity_vectorq",
    "output.wrimap_volume1",
    "output.wrimap_volume_on_ground",
    "output.wrimap_water_level_gradient",
    "output.wrimap_waterdepth",
    "output.wrimap_waterdepth_hu",
    "output.wrimap_waterdepth_on_ground",
    "output.wrimap_waterlevel_s0",
    "output.wrimap_waterlevel_s1",
    "output.wrimap_waves",
    "output.wrimap_wet_waterdepth_threshold",
    "output.wrimap_wind",
    "output.wrimap_windstress",
    "output.wrimap_wqbot3d",
    "output.wrimap_z0",
    "output.wrirst_bnd",
    "output.wrishp_crs",
    "output.wrishp_dambreak",
    "output.wrishp_dryarea",
    "output.wrishp_emb",
    "output.wrishp_enc",
    "output.wrishp_fxw",
    "output.wrishp_gate",
    "output.wrishp_genstruc",
    "output.wrishp_obs",
    "output.wrishp_pump",
    "output.wrishp_src",
    "output.wrishp_thd",
    ...
    "output.writedetailedtimers",
    "output.writedfminterpretedvalues",
    "output.writek_cdwind",
    "output.writepart_domain",
    "output.writesurfacedatatomapfile",
    "output.wrixyz_numlimdt",
    "output.xlsinterval",
    "particles.3dtype",
    "particles.addtracer",
    "particles.particlesfile",
    "particles.particlesreleasefile",
    "particles.starttime",
    "particles.timestep",
    "physics.ag",
    "physics.albedo",
    "physics.allowcoolingbelowzero",
    "physics.backgroundsalinity",
    "physics.backgroundwatertemperature",
    "physics.betaspiral",
    "physics.breachgrowth",
    "physics.dalton",
    "physics.deltasalinity",
    "physics.dicouv",
    "physics.dicoww",
    "physics.doodsoneps",
    ...
    "physics.epsmin",
    "physics.equili",
    "physics.freeconvectioncoefficient",
    "physics.heat_eachstep",
    "physics.idensform",
    "physics.initialsalinity",
    "physics.initialtemperature",
    "physics.iniwithnudge",
    "physics.irov",
    "physics.itcap",
    "physics.jadelvappos",
    "physics.nfentrainmentmomentum",
    "physics.nudgetimeuni",
    "physics.prandtlnumbertemperature",
    "physics.rhoairrhowater",
    "physics.rhomean",
    "physics.sal0abovezlev",
    "physics.salimax",
    "physics.salimin",
    "physics.salinity",
    "physics.salinitydependentfreezingpoint",
    "physics.schmidtnumbersalinity",
    "physics.schmidtnumbertracer",
    "physics.secchidepth",
    "physics.secchidepth2",
    "physics.secchidepth2fraction",
    "physics.secchidepthnonpenetrative",
    "physics.secchidepthnonpenetrativefraction",
    "physics.secondaryflow",
    "physics.selfattractionloading",
    "physics.selfattractionloading_correct_wl_with_ini",
    "physics.smagorinsky",
    "physics.soiltempthick",
    "physics.stanton",
    "physics.stericcorrection",
    "physics.surftempsmofac",
    "physics.taumin",
    "physics.temperature",
    "physics.tempmax",
    "physics.tempmin",
    "physics.thermobaricity",
    "physics.thermobaricityinpressuregradient",
    "physics.tidalforcing",
    "physics.tkemin",
    "physics.umodlin",
    "physics.uniffrictcoef",
    "physics.uniffrictcoef1d",
    "physics.uniffrictcoef1d2d",
    "physics.uniffrictcoef1dgrlay",
    "physics.uniffrictcoeflin",
    "physics.uniffricttype",
    "physics.vicouv",
    "physics.vicoww",
    "physics.vicwminb",
    "physics.villemontecd1",
    "physics.villemontecd2",
    "physics.wall_ks",
    "physics.xlozmidov",
    "processes.additionalhistoryoutputfile",
    "processes.depthdrythreshold",
    "processes.dtmassbalance",
    "processes.dtprocesses",
    "processes.processfluxintegration",
    "processes.statisticsfile",
    "processes.substancedensitycoupling",
    "processes.substancefile",
    "processes.thetavertical",
    "processes.volumedrythreshold",
    "processes.wriwaqbot3doutput",
    "restart.restartdatetime",
    "restart.restartfile",
    "restart.rstignorebl",
    "sediment.alfabed",
    "sediment.alfasus",
    "sediment.bndtreatment",
    "sediment.crefcav",
    "sediment.d50",
    "sediment.dredgefile",
    "sediment.dzbdtmax",
    "sediment.erosionpar",
    "sediment.implicitfallvelocity",
    "sediment.initialsedimentconcentration",
    "sediment.inmorphopol",
    "sediment.jaceneqtr",
    "sediment.masbalmindep",
    "sediment.morcfl",
    "sediment.morfac",
    "sediment.morfile",
    "sediment.mormergedtuser",
    "sediment.morphopol",
    "sediment.mxgrkrone",
    "sediment.nr_of_sedfractions",
    "sediment.numintverticaleinstein",
    "sediment.rhosed",
    "sediment.seddenscoupling",
    "sediment.sedfile",
    "sediment.sedimentmodelnr",
    "sediment.soursink",
    "sediment.taucre",
    "sediment.tmorfspinup",
    "sediment.uniformerodablethickness",
    "sediment.upperlimitssc",
    "sediment.ws",
    "sedtrails.sedtrailsanalysis",
    "sedtrails.sedtrailsgrid",
    "sedtrails.sedtrailsinterval",
    "sedtrails.sedtrailsoutputfile",
    "time.autotimestep",
    "time.autotimestepdiff",
    "time.autotimestepnoqout",
    "time.autotimestepnostruct",
    "time.autotimestepvisc",
    "time.dtfacmax",
    "time.dtinit",
    "time.dtmax",
    "time.dtnodal",
    ...
    "time.refdate",
    "time.startdatetime",
    "time.startdatetimetlfsmo",
    "time.stopdatetime",
    "time.timestepanalysis",
    "time.tstart",
    "time.tstarttlfsmo",
    "time.tstop",
    "time.tunit",
    "time.tzone",
    "time.updateroughnessinterval",
    "trachytopes.dttrt",
    "trachytopes.trtcll",
    "trachytopes.trtdef",
    "trachytopes.trtdt",
    ...
    "veg.expchistem",
    "veg.rhoveg",
    "veg.stemheightconvention",
    "veg.stemheightstd",
    "veg.uchileaf",
    "veg.uchistem",
    "veg.vegetationmodelnr",
    "volumetables.increment",
    "volumetables.usevolumetablefile",
    "volumetables.usevolumetables",
    "waves.3dstokesprofile",
    "waves.3dwaveboundarylayer",
    "waves.3dwavebreakerturbulence",
    "waves.3dwavestreaming",
    "waves.flowwithoutwaves",
    "waves.gammax",
    "waves.hminlw",
    "waves.hwavuni",
    "waves.jahissigwav",
    ...
    "waves.wavemodelnr",
    "waves.wavenikuradse",
    "waves.waveswartdelwaq",
    "wind.cdbreakpoints",
    "wind.computedairdensity",
    "wind.gapres",
    "wind.icdtyp",
    "wind.pavbnd",
    "wind.pavini",
    "wind.relativewind",
    "wind.rhoair",
    "wind.rhowaterinwindstress",
    "wind.stresstowind",
    "wind.varyingairdensity",
    "wind.wind_eachstep",
    "wind.windhuorzwsbased",
    "wind.windpartialdry",
