...
lib.mdu_get_datetime.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.POINTER(ctypes.c_int64), ctypes.POINTER(ctypes.c_int32)]
lib.mdu_get_datetime.restype = ctypes.c_int32
lib.mdu_get_string_enum.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.POINTER(ctypes.c_char_p)]
lib.mdu_get_string_enum.restype = ctypes.c_int32
lib.mdu_get_int_enum.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.POINTER(ctypes.c_int32)]
lib.mdu_get_int_enum.restype = ctypes.c_int32
...
lib.mdu_set_datetime.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_int64, ctypes.c_int32]
lib.mdu_set_datetime.restype = ctypes.c_int32
lib.mdu_set_string_enum.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_char_p]
lib.mdu_set_string_enum.restype = ctypes.c_int32
lib.mdu_set_int_enum.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_int32]
lib.mdu_set_int_enum.restype = ctypes.c_int32
