...
internal sealed class MduSourceGenerator : IIncrementalGenerator
{
    ...
    private static void WriteSection(StringBuilder sb, MduSection section)
    {
        ...
        sb.AppendLine("    {");
        sb.AppendLine("        private readonly MduApi api;");
        sb.AppendLine();
        sb.AppendLine($"         /// <summary>Initializes a new instance of <see cref=\"{sectionName}Section\"/> class.</summary>");
        sb.AppendLine($"        internal {sectionName}Section(MduApi api) => this.api = api;");
