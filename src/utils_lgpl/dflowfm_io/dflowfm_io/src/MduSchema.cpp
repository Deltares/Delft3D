            ...
            SectionSchema {
                ...
                .properties  = {
                    ...
                    PropertySchema {
                        ...
                        .required          = false,
                        .value_type        = ValueType::String,
                        .default_value     = std::string{"1.2.60.64623M"},
                        .default_value_str = "1.2.60.64623M",
                    ...
                    PropertySchema {
                        ...
                        .required          = true,
                        .value_type        = ValueType::String,
                        .default_value     = std::string{"1.09"},
                        .default_value_str = "1.09",
            ...
            SectionSchema {
                ...
                .properties  = {
                    ...
                    PropertySchema {
                        ...
                        .value_type        = ValueType::Enum,
                        .default_value     = EnumValue{0},
                        .default_value_str = "internalNetlinksEdge",
                        .enum_values       = {
            ...
            SectionSchema {
                ...
                .properties  = {
                    ...
                    PropertySchema {
                        ...
                        .required          = false,
                        .value_type        = ValueType::IntEnum,
                        .default_value     = EnumValue{33},
                        .default_value_str = "33",
                        .enum_values       = {
                            {0, "no"},
                            {3, "Perot q(uiou)"},
                    ...
                    PropertySchema {
                        ...
                        .value_type        = ValueType::Enum,
                        .default_value     = EnumValue{1},
                        .default_value_str = "higherOrderUpwindExplicit",
                        .enum_values       = {
                            {0, "centralImplicit"},
            ...
            SectionSchema {
                ...
                .properties  = {
                    ...
                    PropertySchema {
                        ...
                        .value_type        = ValueType::Enum,
                        .default_value     = EnumValue{2},
                        .default_value_str = "symmetric-asymmetric",
                        .enum_values       = {
                            {0, "symmetric"},
                            {1, "proportional"},
            ...
            SectionSchema {
                ...
                .properties  = {
                    ...
                    PropertySchema {
                        ...
                        .required          = false,
                        .value_type        = ValueType::FloatList,
                        .default_value     = std::vector<double>{300.0},
                        .default_value_str = "300.0",
                    ...
                    PropertySchema {
                        ...
                        .required          = false,
                        .value_type        = ValueType::FloatList,
                        .default_value     = std::vector<double>{1200.0},
                        .default_value_str = "1200.0",
            ...
            SectionSchema {
                ...
                .properties  = {
                    ...
                    PropertySchema {
                        ...
                        .value_type        = ValueType::Enum,
                        .default_value     = EnumValue{0},
                        .default_value_str = "upward_from_bed",
                        .enum_values       = {
                            {0, "upward_from_bed"},
