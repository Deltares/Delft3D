...
!C    NAMSUB = parameter used in CALL ERRMSG2 if error message occurs
!C    FILSUB = parameter used in CALL ERRMSG2 if error message occurs
...
!    NAMSUB = parameter used in CALL ERRMSG2 if error message occurs
!    FILSUB = parameter used in CALL ERRMSG2 if error message occurs
