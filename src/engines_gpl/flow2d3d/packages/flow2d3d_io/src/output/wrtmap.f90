...
!             ierror   = nf90_put_att(fds, idvar_s1, 'grid_mapping', 'projected_coordinate_system'); call nc_check_err(lundia, ierror, "put_att waterlevel projection", filename)
       ...
       if (stressStrainRelation) then
          ...
          call addelm(gdp, lundia, FILOUT_MAP, grnam3, 'XMU', ' ', IO_REAL4         , 3, dimids=(/iddim_n, iddim_m, iddim_kmax/), longname='Viscosity of mixture', unit='Pa s', acl='z')
          call addelm(gdp, lundia, FILOUT_MAP, grnam3, 'TYIELD', ' ', IO_REAL4         , 3, dimids=(/iddim_n, iddim_m, iddim_kmax/), longname='Yield stress of mixture', unit='Pa', acl='z')
          call addelm(gdp, lundia, FILOUT_MAP, grnam3, 'TAUBH', ' ', IO_REAL4         , 3, dimids=(/iddim_n, iddim_m, iddim_kmax/), longname='Shear stress of mixture', unit='Pa', acl='z')
          ...
          call addelm(gdp, lundia, FILOUT_MAP, grnam3, 'CFMU', ' ', IO_REAL4         , 3, dimids=(/iddim_n, iddim_m, iddim_kmax/), longname='Viscosity of carrier fluid', unit='Pa s', acl='z')
          call addelm(gdp, lundia, FILOUT_MAP, grnam3, 'CFTY', ' ', IO_REAL4         , 3, dimids=(/iddim_n, iddim_m, iddim_kmax/), longname='Yield stress of carrier fluid', unit='Pa', acl='z')
          call addelm(gdp, lundia, FILOUT_MAP, grnam3, 'CFTAU', ' ', IO_REAL4         , 3, dimids=(/iddim_n, iddim_m, iddim_kmax/), longname='Shear stress of carrier fluid', unit='Pa', acl='z')
       endif
