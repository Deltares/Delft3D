             ...
             do l = 1, lsedtot
                do m = 1, mmax
                   do n = 1, nmaxus
                      ...
                      rbuff3(n, m, l) = sbuuc(nm, l) / (gdp%gdsedpar%sedtrans_unitcov_fac(l) * dmorfs)
                   enddo
                enddo
             enddo
          else
          ...
          if ( dmorft > 0.0_hp ) then
             ...
             do l = 1, lsedtot
                do m = 1, mmax
                   do n = 1, nmaxus
                      call n_and_m_to_nm(n, m, nm, gdp)
                      rbuff3(n, m, l) = sbvvc(nm, l) / (gdp%gdsedpar%sedtrans_unitcov_fac(l) * dmorfs)
                   enddo
                enddo
             enddo
          else
             ...
             if ( dmorft > 0.0_hp ) then
                ...
                do l = 1, lsedtot
                   do m = 1, mmax
                      do n = 1, nmaxus
                         call n_and_m_to_nm(n, m, nm, gdp)
                         rbuff3(n, m, l) = ssuuc(nm, l) / (gdp%gdsedpar%sedtrans_unitcov_fac(l) * dmorfs)
                      enddo
                   enddo
                enddo
             else
             ...
             if ( dmorft > 0.0_hp ) then
                ...
                do l = 1, lsedtot
                   do m = 1, mmax
                      do n = 1, nmaxus
                         call n_and_m_to_nm(n, m, nm, gdp)
                         rbuff3(n, m, l) = ssvvc(nm, l) / (gdp%gdsedpar%sedtrans_unitcov_fac(l) * dmorfs)
                      enddo
                   enddo
                enddo
             else
