...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: wrimap.f90 5846 2016-02-15 17:33:03Z jagers $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/Deltares/20160126_PLIC_VOF_bankEROSION/src/engines_gpl/flow2d3d/packages/io/src/output/wrimap.f90 $
!!--description-----------------------------------------------------------------
!
...
!
    ...
    case (REQUESTTYPE_DEFINE)
       ...
       call addelm(gdp, lundia, ifile, grnam2, 'XCOR', xcoordname, IO_REAL4, 2, dimids=(/iddim_nc, iddim_mc/), longname='X-coordinate of grid points', unit=xcoordunit) ! optionally double precision?
       call addelm(gdp, lundia, ifile, grnam2, 'YCOR', ycoordname, IO_REAL4, 2, dimids=(/iddim_nc, iddim_mc/), longname='Y-coordinate of grid points', unit=ycoordunit) ! optionally double precision?
       call addelm(gdp, lundia, ifile, grnam2, 'XZ', xcoordname, IO_REAL4  , 2, dimids=(/iddim_n , iddim_m /), longname='X-coordinate of cell centres', unit=xcoordunit) ! optionally double precision?
       call addelm(gdp, lundia, ifile, grnam2, 'YZ', ycoordname, IO_REAL4  , 2, dimids=(/iddim_n , iddim_m /), longname='Y-coordinate of cell centres', unit=ycoordunit) ! optionally double precision?
