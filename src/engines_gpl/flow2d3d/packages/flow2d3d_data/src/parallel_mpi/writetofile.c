...
// $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/Deltares/20160126_PLIC_VOF_bankEROSION/src/engines_gpl/flow2d3d/packages/data/src/parallel_mpi/writetofile.c $
#include<assert.h>
#include<math.h>
#include<stdio.h>
#include<stdlib.h>
