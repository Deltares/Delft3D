...
subroutine couple_to_greeter_dummy()
   ...
   function initialize_fm_coupling() result(vertex_ids)
      ...
      mesh_coordinates = [0.0_c_double, 0.0_c_double, 0.0_c_double, 1.0_c_double, 0.5_c_double, 1.0_c_double, 1.0_c_double, 1.0_c_double, 1.0_c_double, 0.0_c_double, 0.5_c_double, 0.0_c_double]
