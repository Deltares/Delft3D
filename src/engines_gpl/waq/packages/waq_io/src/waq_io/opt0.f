...
!     kind           function         name           Descriptipon
      ...
      integer(kind=int_32), intent(in   ) ::  noql1          !< number of exchanges 1st direction
      integer(kind=int_32), intent(in   ) ::  noql2          !< number of exchanges 2nd direction
      integer(kind=int_32), intent(in   ) ::  noql3          !< number of exchanges 3rd direction
      integer(kind=int_32), intent(in   ) ::  ndim2          !< number of items per block
      integer(kind=int_32), intent(in   ) ::  ndim3          !< number of scale factors
      integer(kind=int_32), intent(inout) ::  nrftot         !< number of functions
      integer(kind=int_32), intent(inout) ::  nrharm         !< number of harmonics
      ...
      integer(kind=int_32), intent(inout) ::  volume         !< if 1 then volume ( out: 0 = computed volumes )
      ...
      integer(kind=int_32) :: iopt1        !  first  option ( type of file e.g. 0 = binary file )
      integer(kind=int_32) :: iopt2        !  second option ( 1,2 = constant, 3 = time varying )
      integer(kind=int_32) :: ndim1        !  sum of input in 3 directions
      integer(kind=int_32) :: ndtot        !  total size of matrix (ndim1*ndim2)
      integer(kind=int_32) :: ierr2        !  local error flag
      integer(kind=int_32) :: itype        !  to identify the data type read
      integer(kind=int_32) :: idummy       !  work integer ( = 0 )
      real(kind=sp) :: adummy       !  work real    ( = 0.0 )
      character(128) cdummy      !  work character
      integer(kind=int_32) :: k            !  loop counter
      real(kind=sp) :: disp(3,1)    !  dispersions in 3 directions
      real(kind=sp), allocatable ::  values(:,:)  ! read buffer for the values
