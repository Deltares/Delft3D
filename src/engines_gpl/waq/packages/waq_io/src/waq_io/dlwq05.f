...
!     kind           function         name                Descriptipon
      ...
      integer(kind=int_32), intent(in   ) ::  nobnd              !< number of open model boundaries
      ...
      integer(kind=int_32), intent(  out) ::  nobtyp             !< number of open model boundary types
 ...
 !
      ...
      INTEGER(kind=int_32), ALLOCATABLE ::  IBNDTYPE(:)             ! index boundary type
      ...
      real(kind=sp) ::  rdummy                  ! dummy real in argument list
      integer(kind=int_32) ::  idummy                  ! dummy integer in argument list
      integer(kind=int_32) ::  VOLUME 
      integer(kind=int_32) ::  ithndl = 0 
      integer(kind=int_32) ::  k, I, IERR_ALLOC 
      integer(kind=int_32) ::  ifact, lunwr, ierr2, iwar2, ifound, ityp2 
      integer(kind=int_32) ::  iaropt, nover, mxover, ibnd, it, nosubs 
      integer(kind=int_32) ::  ierrh, ihulp, rhulp, ifound2, l, itype 
