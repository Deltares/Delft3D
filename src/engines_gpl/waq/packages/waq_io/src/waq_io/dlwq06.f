...
!     type     kind  function         name             description
      ...
      integer(kind=int_32), intent(inout) ::  filtype(*)      !< type of binary files
      ...
      integer(kind=int_32), intent(inout) ::  iar   (iimax)   !< local integer   workspace
      integer(kind=int_32), intent(in   ) ::  irmax           !< size of the real      workspace
      real(kind=sp), intent(inout) ::  rar   (irmax)   !< local real      workspace
      ...
      integer(kind=int_32), intent(  out) ::  nowst           !< number of waste loads
      integer(kind=int_32), intent(  out) ::  nowtyp          !< number of waste load types
      integer(kind=int_32), intent(inout) ::  nrftot( 11 )    !< number of function items per kind
      integer(kind=int_32), intent(inout) ::  nrharm( 11 )    !< number of harmonic items per kind
      ...
      integer(kind=int_32), intent(in   ) ::  ioutpt          !< Degree of output in report file
...
!     local
      ...
      integer(kind=int_32), allocatable ::  iwstseg     (:)  !  wasteload segment
      integer(kind=int_32), allocatable ::  iwsttype    (:)  !  index wasteload type
      integer(kind=int_32), allocatable ::  iwstkind    (:)  !  kind array: 0 = pres: use present situation
      ...
      integer(kind=int_32) :: lunwr            !  binary unit for wasteloads
      integer(kind=int_32) :: itype            !  type of token that is read
      integer(kind=int_32) :: ierr2            !  local error indicator
      integer(kind=int_32) :: ierr_alloc       !  local error indicator for allocation
      integer(kind=int_32) :: i                !  loop counter
      integer(kind=int_32) :: ifound           !  help variable in searches
      integer(kind=int_32) :: ifound2          !  help variable in searches
