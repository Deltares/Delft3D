...
contains
   ...
   subroutine test_with_normal_source_sinks() bind(C)
      ...
      call create_file("FlowFM_sourcesink.bc", [character(len=512) :: &
                       "[General]", &
                       "    fileVersion           = 1.01", &
                       "    fileType              = boundConds", &
                       "", &
      ...
      call create_file("bubble_discharge.bc", [character(len=512) :: &
                       "[General]", &
                       "    fileVersion           = 1.01", &
                       "    fileType              = boundConds", &
                       "", &
      ...
      call create_file("bubbles.pli", [character(len=512) :: &
                       "bubbles1", &
                       "    2    2", &
                       "736  1052", &
                       "1253  1046" &
      ...
      call create_file("FlowFM_bnd.ext", [character(len=512) :: &
                       "[SourceSink]", &
                       "   id=SourceSink01", &
                       "   numCoordinates=1", &
                       "   xCoordinates=0", &
