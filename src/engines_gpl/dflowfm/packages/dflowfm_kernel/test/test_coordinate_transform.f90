...
contains
   ...
   subroutine test_cartesian_identity() bind(C)
      ...
      call f90_expect_near(ucx_link_1(1), ucx(1), tolerance, "Link 1, side 1, ucx mismatch")
      call f90_expect_near(ucx_link_2(1), ucx(2), tolerance, "Link 1, side 2, ucx mismatch")
      call f90_expect_near(ucy_link_1(1), ucy(1), tolerance, "Link 1, side 1, ucy mismatch")
      call f90_expect_near(ucy_link_2(1), ucy(2), tolerance, "Link 1, side 2, ucy mismatch")

      ! Link 2: nodes 2 and 3
      call f90_expect_near(ucx_link_1(2), ucx(2), tolerance, "Link 2, side 1, ucx mismatch")
      call f90_expect_near(ucx_link_2(2), ucx(3), tolerance, "Link 2, side 2, ucx mismatch")

      ! Corner velocities
      call f90_expect_near(ucnx_link_1(1), ucnx(1), tolerance, "Link 1, corner 1, ucnx mismatch")
      call f90_expect_near(ucny_link_1(1), ucny(1), tolerance, "Link 1, corner 1, ucny mismatch")
   ...
   subroutine test_spherical_rotation() bind(C)
      ...
      call f90_expect_near(ucx_link_1(1), expected_ucx_node1, tolerance, &
                          "Node 1 ucx transformation incorrect")
      call f90_expect_near(ucy_link_1(1), expected_ucy_node1, tolerance, &
                          "Node 1 ucy transformation incorrect")
      
      call f90_expect_near(ucx_link_2(1), expected_ucx_node2, tolerance, &
                          "Node 2 ucx transformation incorrect")
      call f90_expect_near(ucy_link_2(1), expected_ucy_node2, tolerance, &
                          "Node 2 ucy transformation incorrect")
      
      ! Check corner transformations (should be same as nodes)
      call f90_expect_near(ucnx_link_1(1), expected_ucx_node1, tolerance, &
                          "Corner 1 ucnx transformation incorrect")
      call f90_expect_near(ucny_link_1(1), expected_ucy_node1, tolerance, &
                          "Corner 1 ucny transformation incorrect")
      
      call f90_expect_near(ucnx_link_2(1), expected_ucx_node2, tolerance, &
                          "Corner 2 ucnx transformation incorrect")
      call f90_expect_near(ucny_link_2(1), expected_ucy_node2, tolerance, &
