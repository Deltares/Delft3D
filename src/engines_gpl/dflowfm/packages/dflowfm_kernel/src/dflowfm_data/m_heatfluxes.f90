...
module m_heatfluxes
   ...
   real(kind=dp) :: sarea !< Only for excess temp model temperature_model=3, lake area
   real(kind=dp) :: fwind !< Only for excess temp model temperature_model=3, wind factor
