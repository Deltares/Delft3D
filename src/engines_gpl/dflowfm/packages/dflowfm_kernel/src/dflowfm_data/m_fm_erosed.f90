...
module m_fm_erosed
   ...
   integer, pointer :: ithresh !< switch for method to compute the FIXFAC array 1 = constant value specified using Thresh; 2 = value based on thickness of alluvial transport layer
