...
!! @see writeMDUFile
   subroutine readMDUFile(filename, istat)
      ...
      use unstruc_netcdf, only: output_mask_map
      use dfm_error
...
!> Write a model definition to a file pointer
   subroutine writeMDUFilepointer(mout, writeall, istat)
      ...
      use unstruc_netcdf, only: unc_writeopts, UG_WRITE_LATLON, UG_WRITE_NOOPTS, unc_nounlimited, unc_noforcedflush, unc_uuidgen, unc_metadatafile, output_mask_map
