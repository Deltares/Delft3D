...
! Calibration factor
      ...
      call prop_get(md_ptr, 'output', 'MbaFile', md_mbafile)
...
!   call prop_set(prop_ptr, 'numerics', 'numoverlap', numoverlap, ' ')
      ...
      call prop_set(prop_ptr, 'physics', 'lowerLimitTracer', lowerlimittra, 'Lower limit of cell centre tracer concentration after transport timestep. Default = 0d0 (ensure positivity)')
      call prop_set(prop_ptr, 'physics', 'upperLimitTracer', upperlimittra, 'Upper limit of cell centre tracer concentration after transport timestep. Default = 1d30 (effectively switched off)')
...
! Output
      ...
      call prop_set(prop_ptr, 'output', 'MbaFile', trim(md_mbafile), 'Space-separated input mass balance area file(s) (*_mba.ini).')
