...
! Output
      ...
      call prop_set(prop_ptr, 'output', 'OutputPolygonFile', trim(md_map_output_polyfile), 'Space-separated output polygon file(s) to restrict map output to (e.g., *_out.pol)')
