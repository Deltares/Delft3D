...
module m_turbulence
   ...
   real(kind=dp), allocatable, dimension(:), target :: vicwws !< [m2/s] turbulent vertical eddy viscosity at layer interface at s point {"location": "face", "shape": ["ndkx"]}
   real(kind=dp), allocatable, dimension(:), target :: vicwws_total !< [m2/s] total vertical eddy viscosity at layer interface at s point {"location": "face", "shape": ["ndkx"]}
   real(kind=dp), allocatable, dimension(:), target :: difwws !< [m2/s] turbulent vertical eddy diffusivity of salinity at layer interface at s point {"location": "face", "shape": ["ndkx"]}
   real(kind=dp), allocatable, dimension(:), target :: difwws_total !< [m2/s] total vertical eddy diffusivity of salinity at layer interface at s point {"location": "face", "shape": ["ndkx"]}
