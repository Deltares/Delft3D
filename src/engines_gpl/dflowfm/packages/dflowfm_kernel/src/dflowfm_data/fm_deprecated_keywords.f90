...
!> subroutine that initialises all deprecated keyword sets
   subroutine default_fm_deprecated_keywords()
      ...
      call add_deprecated_keyword(deprecated_mdu_keywords, 'Geometry', 'circumcenterMethod', DEPRECATED, 'Keyword "circumcenterMethod" will be removed in a future release; the option "allNetlinksLoop" will always be used.')
      call add_deprecated_keyword(deprecated_mdu_keywords, 'Geometry', 'circumcenterTolerance', DEPRECATED)
