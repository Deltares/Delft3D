...
!> subroutine that initialises all deprecated keyword sets
   subroutine default_fm_deprecated_keywords()
      ...
      call add_deprecated_keyword(deprecated_mdu_keywords, 'Geometry', 'circumcenterMethod', DEPRECATED, 'The "allNetlinksLoop" method will always be used.')
      call add_deprecated_keyword(deprecated_mdu_keywords, 'Geometry', 'circumcenterTolerance', DEPRECATED, 'A fixed tolerance will always be used.')
