...
!! For a reinit prior to flow computation, only call reset_flowparameters() instead.
   subroutine default_flowparameters()
      ...
      javasal = 4 !< vert. adv. sa1  : 0=No, 1=UpwexpL, 2=Centralexpl, 3=UpwimpL, 4=CentraLimpL, 5=switched to 3 for neg stratif, 6=hoexplicit.
      javatem = 4 !< vert. adv. tem1 : 0=No, 1=UpwexpL, 2=Centralexpl, 3=UpwimpL, 4=CentraLimpL, 5=switched to 3 for neg stratif.
      javased = 4 !< vert. adv. suspended sediment concentrations : 0=No, 1=UpwexpL, 2=Centralexpl, 3=UpwimpL, 4=CentraLimpL, 5=switched to 3 for neg stratif., 6=higher-order upwind/explicit
      vertical_advection_type = 'centralImplicit' !< vertical advection type for tracers and momentum.
      jahazlayer = 0 !<
