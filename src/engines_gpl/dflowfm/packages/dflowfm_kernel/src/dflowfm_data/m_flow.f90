...
! link related, dim = lnkx
 ...
 double precision, allocatable     :: Windspeedfac(:) !< wind speed multiplication factor
 double precision, allocatable     :: solradfac(:)!< solar radiation multiplication factor
