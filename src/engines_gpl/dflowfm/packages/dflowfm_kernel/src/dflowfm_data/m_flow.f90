...
module m_flow ! flow arrays-999
   ...
   real(kind=dp) :: z_layer_growth_factor !< z-layer thickness growth factor starting from the bottom of the bed
...
! 3D parameters
      ...
      z_layer_growth_factor = 1.0_dp !< z-layer thickness growth factor starting from the bottom of the bed
