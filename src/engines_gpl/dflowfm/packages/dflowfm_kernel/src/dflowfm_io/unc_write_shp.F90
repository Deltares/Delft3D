...
contains
   ...
   subroutine unc_write_shp()
      ...
      use fm_external_forcings_data, only: nweirgen, ngategen, num_source_sink, ksrc, gate2cgen, L1cgensg, L2cgensg, npumpsg, L1pumpsg, L2pumpsg, ngenstru, genstru2cgen, weir2cgen
