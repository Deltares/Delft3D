...
!-----------------------------------------------------------------------------------------------
      ...
      if (wrwaqon) then
         ...
         if (allocated(source_sink_cum_discharge_waq)) then
            source_sink_cum_discharge_waq_prev = source_sink_cum_discharge_waq
         end if
...
!    synchronise all water-levels
                  ...
                  if (key == 1) then
                     ...
                     if (wrwaqon) then
                        ...
                        if (allocated(source_sink_cum_discharge_waq)) then
                           source_sink_cum_discharge_waq = source_sink_cum_discharge_waq_prev
                        end if
                        if (allocated(qlatwaq)) then
                           qlatwaq = qlatwaq0
                        end if
