...
contains
   ...
   subroutine heatu(time_in_hours)
      ...
      use m_flow, only: qtotmap, qsunmap, qevamap, qconmap, qlongmap, qfrevamap, qfrconmap, jamapheatflux, write_his_output, &
      ...
      if (jamapheatflux > 0 .or. write_his_output%heatflux > 0) then
