   ...
   !> set friction coefficient by initial fields
   ...
   use m_physcoef,    only : frcuni1d, frcuni1d2d, frcunistreetinlet, frcuniroofgutterpipe, frcuni, frcmax, ifrctypuni, dynroughveg, frcumin
