...
! $Id: wave_comp_stokes_velocities.f90 142062 2022-11-22 12:11:24Z reyns $
! $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/Deltares/20221101_SO_3dwaves/src/engines_gpl/dflowfm/packages/dflowfm_kernel/src/dflowfm_kernel/compute_waves/wave_comp_stokes_velocities.f90 $

   subroutine wave_comp_stokes_velocities_2d()
...
1234 continue
   return
   end subroutine wave_comp_stokes_velocities_2d
