...
!  for 2 of the 4 input fields
      ...
      call IFormPutDouble(2 * 6, vicoww%get(1), '(e8.3)')
      call IFORMPUTdouble(2 * 7, dicouv, '(e8.3)')
      call IFORMPUTdouble(2 * 8, dicoww%get(1), '(e8.3)')
...
!  check for Help, Confirm, Quit
      ...
      if (KEY == 26) then
         ...
         if (KEY == 22) then
            ...
            call IFormGetDouble(2 * 6, vicoww%get(1))
            call IFORMGetdouble(2 * 7, dicouv)
            call IFORMGetdouble(2 * 8, dicoww%get(1))
