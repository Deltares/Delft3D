...
contains
   ...
   subroutine test_genstru_1d2d_crestwidth_reduced() bind(C)
      ...
      call f90_expect_near(q_w_50m_no_door, q_w100_door_opening_50m, q_w_50m_no_door*tolerance, &
               "The discharge for no door is different from the discharge for a door obstructing a part of the structure.")
