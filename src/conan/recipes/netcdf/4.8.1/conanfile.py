...
class NetcdfConan(ConanFile):
    ...
    def generate(self):
        ...
        tc.variables["ENABLE_PARALLEL4"] = False
        tc.variables["ENABLE_PARALLEL_TESTS"] = False
        tc.variables["ENABLE_NCZARR"] = False
        tc.variables["ENABLE_DAP_REMOTE_TESTS"] = False
        tc.variables["HDF5_HAS_COLL_METADATA_OPS"] = ""
        tc.variables["HDF5_IS_PARALLEL_MPIO"] = ""
