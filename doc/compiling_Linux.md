...
## Prerequisites
This section follows the content of `ci/dockerfiles/linux/buildtools.Dockerfile`.
...
This section follows the content of `ci/dockerfiles/linux/third-party-libs.Dockerfile`.

```
INTEL_ONEAPI_VERSION=2024
INTEL_FORTRAN_COMPILER=ifort
DEBUG=0
CACHE_ID_SUFFIX=cache-${INTEL_ONEAPI_VERSION}-${INTEL_FORTRAN_COMPILER}-${DEBUG}
```

- Compression libraries: zlib, libaec, zstd
```
source /opt/intel/oneapi/setvars.sh
