...
- Prerequisites and **compilation steps** for [Windows](compiling_Windows.md) and [Linux](compiling_Linux.md).
- To be added section on **Building containers**; for the time being check the ci/dockerfiles folder.
