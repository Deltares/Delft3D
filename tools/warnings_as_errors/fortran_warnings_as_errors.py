...
def main():
    ...
    parser.add_argument(
        ...
        nargs="*",
        action="append",
        help="Filter warnings and remarks by file path. Only file paths that contain at least one FILTER string are included.",
    )
    ...
    if args.print_messages:
        for entry in messages:
            print(
                f"{f'{args.project_name}: ' if args.project_name else ''}The following {entry.message_type} was treated as an error:"
            )
